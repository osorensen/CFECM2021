...
- The number of smoothing parameters is typically high $(\geq 10)$, making Cartesian product quadrature unfeasible. Spherical cubature rules of order 5 exist for arbitrary high dimensions, with a number of quadrature points growing quadratically in the dimension<sup>1</sup>.
